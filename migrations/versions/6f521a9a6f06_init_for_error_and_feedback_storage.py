"""init for error and feedback storage

Revision ID: 6f521a9a6f06
Revises: 
Create Date: 2025-11-10 17:57:41.308546
...
def upgrade() -> None:
    ...
    sa.Column('rev_project', sa.String(), nullable=False),
